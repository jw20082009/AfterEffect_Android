...
package com.eyedog.basic.multitouch;
...
public abstract class VersionedGestureDetector {
    ...
    public interface OnGestureListener {
        ...
        void onScale(float scaleFactor, float focusX, float focusY, float previousSpan,
            float currentSpan);
        ...
        private final OnScaleGestureListener mScaleListener = new OnScaleGestureListener() {
            ...
            public boolean onScale(ScaleGestureDetector detector) {
                mListener.onScale(detector.getScaleFactor(), detector.getFocusX(),
                        detector.getFocusY(),detector.getPreviousSpan(),detector.getCurrentSpan());
                return true;
            }
